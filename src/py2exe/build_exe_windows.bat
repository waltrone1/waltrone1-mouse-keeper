...
set "APP_NAME=waltrone1-Mouse-Keeper"
set "ENTRY_FILE=%PROJECT_DIR%\main.py"
set "ICON_FILE=%PROJECT_DIR%\waltrone1-Mouse-Keeper.ico"
set "VERSION_FILE=%PROJECT_DIR%\version_info.txt"
set "SPEC_FILE=%PY2EXE_DIR%\waltrone1_Mouse_Keeper_py2exe.spec"
set "DIST_DIR=%PY2EXE_DIR%\dist"
set "WORK_DIR=%PY2EXE_DIR%\build"

cls
echo ==================================================
echo  waltrone1-Mouse-Keeper - EXE Build
echo ==================================================
echo.
...
if not exist "%ICON_FILE%" (
    ...
    echo %ICON_FILE%
    echo.
    echo Das Icon muss im Hauptordner liegen:
    echo Projektordner\waltrone1-Mouse-Keeper.ico
    pause
    exit /b 1
)
...
if %errorlevel% neq 0 (
    ...
    echo Bitte Python 3 von python.org installieren und "Add python.exe to PATH" aktivieren.
    pause
    exit /b 1
)
